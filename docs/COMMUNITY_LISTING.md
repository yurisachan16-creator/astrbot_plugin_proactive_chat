...
- [x] `docs/RELEASE_0.1.7.md` 已准备 GitHub Release 内容。
- [x] GitHub Release `v0.1.7` 可访问：https://github.com/yurisachan16-creator/astrbot_plugin_proactive_chat/releases/tag/v0.1.7
