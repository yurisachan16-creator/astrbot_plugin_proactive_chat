...
- [ ] 在真实 AstrBot 环境安装 `astrbot-plugin-proactive-chat==0.1.3`。
...
- [ ] README 首页明确推荐 `astrbot-plugin-proactive-chat==0.1.3`。
...
- [ ] 判断是否需要发布 `0.1.4` 来修复 P0 实机验证发现的问题。
- [ ] 如果发布 `0.1.4`，必须重新跑干净 PyPI 安装验证。
