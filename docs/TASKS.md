...
- [ ] 在真实 AstrBot 环境安装 `astrbot-plugin-proactive-chat==0.1.2`。
...
- [ ] README 首页明确推荐 `astrbot-plugin-proactive-chat==0.1.2`。
...
- [ ] 判断是否需要发布 `0.1.3` 来同步 wheel 内 `metadata.yaml` 的版本字段。
- [ ] 如果发布 `0.1.3`，必须重新跑干净 PyPI 安装验证。
